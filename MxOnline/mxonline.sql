...
CREATE TABLE `Banner` (
  ...
  `url` varchar(200) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `Coures` (
  ...
  `detail` longtext COLLATE utf8_general_ci NOT NULL,
  `degree` varchar(5) COLLATE utf8_general_ci NOT NULL,
  ...
  `category` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `tag` varchar(20) COLLATE utf8_general_ci,
  `kcxz` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  `xdaoshenm` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `CourseComments` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `comments` varchar(300) COLLATE utf8_general_ci NOT NULL,
  `add_time` datetime NOT NULL,
...
CREATE TABLE `CourseResource` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `download` varchar(150) COLLATE utf8_general_ci NOT NULL,
  `add_time` datetime NOT NULL,
  `course_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `EmailVerifyRecord` (
  ...
  `send_type` varchar(20) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `Teacher` (
  ...
  `work_comfany` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `work_position` varchar(60) COLLATE utf8_general_ci NOT NULL,
  `points` varchar(30) COLLATE utf8_general_ci NOT NULL,
  ...
  `teacher_td` varchar(50) COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `UserAsk` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `name` varchar(20) COLLATE utf8_general_ci NOT NULL,
  `mobile` varchar(11) COLLATE utf8_general_ci NOT NULL,
  `course_name` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `add_time` datetime NOT NULL,
  PRIMARY KEY (`id`)
...
CREATE TABLE `UserMessage` (
  ...
  `message` varchar(500) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `Video` (
  ...
  `video_url` varchar(200) COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `auth_permission` (
  ...
  `codename` varchar(100) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `captcha_captchastore` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `challenge` varchar(32) COLLATE utf8_general_ci NOT NULL,
  `response` varchar(32) COLLATE utf8_general_ci NOT NULL,
  `hashkey` varchar(40) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `django_admin_log` (
  ...
  `object_id` longtext COLLATE utf8_general_ci,
  `object_repr` varchar(200) COLLATE utf8_general_ci NOT NULL,
  `action_flag` smallint(5) unsigned NOT NULL,
  `change_message` longtext COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `django_content_type` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `app_label` varchar(100) COLLATE utf8_general_ci NOT NULL,
  `model` varchar(100) COLLATE utf8_general_ci NOT NULL,
  PRIMARY KEY (`id`),
...
CREATE TABLE `django_migrations` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `app` varchar(255) COLLATE utf8_general_ci NOT NULL,
  `name` varchar(255) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `django_session` (
  `session_key` varchar(40) COLLATE utf8_general_ci NOT NULL,
  `session_data` longtext COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `users_userprofile` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `username` varchar(150) COLLATE utf8_general_ci NOT NULL,
  `password` varchar(128) COLLATE utf8_general_ci NOT NULL,
  `last_login` datetime DEFAULT NULL,
  `is_superuser` tinyint(1) NOT NULL,
  `first_name` varchar(30) COLLATE utf8_general_ci NOT NULL,
  `last_name` varchar(30) COLLATE utf8_general_ci NOT NULL,
  `email` varchar(254) COLLATE utf8_general_ci NOT NULL,
  `is_staff` tinyint(1) NOT NULL,
  `is_active` tinyint(1) NOT NULL,
  `date_joined` datetime NOT NULL,
  `nick_name` varchar(30) COLLATE utf8_general_ci NOT NULL,
  `birday` date DEFAULT NULL,
  `address` varchar(200) COLLATE utf8_general_ci NOT NULL,
  `mobile` varchar(11) COLLATE utf8_general_ci DEFAULT NULL,
  `image` varchar(100) COLLATE utf8_general_ci DEFAULT NULL,
  `gender` varchar(10) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `xadmin_bookmark` (
  ...
  `url_name` varchar(64) COLLATE utf8_general_ci NOT NULL,
  `query` varchar(1000) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `xadmin_log` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `action_time` datetime NOT NULL,
  `ip_addr` char(39) COLLATE utf8_general_ci DEFAULT NULL,
  `object_id` longtext COLLATE utf8_general_ci,
  `object_repr` varchar(200) COLLATE utf8_general_ci NOT NULL,
  `action_flag` varchar(32) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `xadmin_usersettings` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `key` varchar(256) COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `xadmin_userwidget` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `page_id` varchar(256) COLLATE utf8_general_ci NOT NULL,
  `widget_type` varchar(50) COLLATE utf8_general_ci NOT NULL,
  `value` longtext COLLATE utf8_general_ci NOT NULL,
  `user_id` int(11) NOT NULL,
  PRIMARY KEY (`id`),
